...
g++ -o "TBCNNtest" ./src/FFNN.o ./src/activation.o ./src/global.o ./src/main.o ./src/read_data.o ./src/predict.o ../CBLAS/lib/cblas_WINDOWS.a ../BLAS/lib/libopenblas.a -lgfortran -lpthread
